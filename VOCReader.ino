...
// Lectura del Electrochemical TVOC Detection Module ZE40B-TVOC usando SoftwareSerial
#include <SoftwareSerial.h>

// SoftwareSerial setup: RX on pin 26, TX on pin 27
SoftwareSerial vocSerial(26, 27);
